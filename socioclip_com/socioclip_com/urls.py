...
urlpatterns = [
    ...
    url(r'^search/$', 'socioclip.views.search', name='search'),
    ...
    url(r'^unarchive/$', 'socioclip.views.unarchive', name='unarchive'),
    ...
    url(r'^viewfoldercont/$', 'socioclip.views.viewfoldercont', name='viewfoldercont'),
    ...
    url(r'^deletebookmark/$', 'socioclip.views.deletebookmark', name='deletebookmark'),
    url(r'^geteditdetail/$', 'socioclip.views.geteditdetail', name='geteditdetail'),
    url(r'^editbookmark/$', 'socioclip.views.editbookmark', name='editbookmark'),
